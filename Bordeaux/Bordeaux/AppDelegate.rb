...
class AppDelegate
  attr_accessor :window, :path_to_root
  ...
  #
  # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "Bordeaux" in the user's Library directory.
  #
  def applicationFilesDirectory
      ...
      library_url.URLByAppendingPathComponent("Bordeaux")
  end
  ...
  def managedObjectModel
      unless @managedObjectModel
        model_url = NSBundle.mainBundle.URLForResource("Bordeaux", withExtension:"momd")
  ...
  def persistentStoreCoordinator
      ...
      url = directory.URLByAppendingPathComponent("Bordeaux.storedata")
